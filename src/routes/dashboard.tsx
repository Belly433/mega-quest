      ...
      <main className="max-w-6xl mx-auto px-6 pb-20">
        <div className="flex items-end justify-between flex-wrap gap-4 mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Create, host, and review results.</p>
          </div>
          <Link
            to="/create-quiz"
        ...
        {loading ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {quizzes.map((q) => (
              ...
              >
                <div className="text-xs uppercase tracking-wider text-primary font-bold">Quiz</div>
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-bold hover:scale-[1.02] transition-transform"
                  >
                    Host
                  </button>
                  <Link
...
function EmptyState() {
  return (
    <div className="bg-gradient-card border rounded-3xl p-12 text-center shadow-card">
      ...
      <p className="mt-1 text-muted-foreground">Create your first quiz to get started.</p>
      <Link
        to="/create-quiz"
